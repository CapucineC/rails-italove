...
piemont = Province.create(
  ...
  description:"Le Piémont chevauche le massif des Alpes et s'étend sur la vaste plaine du Pô. C'est de sa géographie qu'il tire son nom, dont l'origine latine signifie 'au pied des montagnes'. A cheval sur deux pays, le Piémont fut longtemps disputé entre la France et l'Italie. Et puis, au fil des siècles, il fut délimité par les ducs de Savoie autour de Turin. Ville solennelle et chef-lieu du Piémont, Turin garde en elle la dignité royale qui a présidé à sa construction. Par la suite, les ducs de Savoie eurent un grand rôle dans l'unification de l'Italie. Ils surent rassembler les diverses régions en un seul pays, aidés en cela par une autre famille piémontaise, les Cavour. C’est donc le Piémont qui a imaginé, voulu et réalisé la création de l’Italie. Comment ne pas rêver de gloire, quand la géographie vous place au pied du Mont Blanc, et que vous êtes sans cesse bercé par les sommets ?")
turin = City.create(
  name:"Turin",
...
lombardie = Province.create(
  ...
  description:"À la chute de l'empire romain, le peuple germanique des Lombards a envahi le nord de l'Italie pour rester dans cette région à laquelle ils ont laissé leur nom. Avoisinant les Alpes et sertie par les grands lacs, la nature lombarde est froide et bleutée. Les villes, elles, ont été créées par des dynasties ambitieuses et belliqueuses qui les ont parées de prestigieux monuments : dômes, palais de marbres et forteresses se dressent élégamment vers le ciel pour côtoyer les nuages. Dans les rues de Milan, chef-lieu de la région et capitale économique de l'Italie, les piétons empressés traversent les avenues, corso et rues d'un pas rapide et sûr, tout absorbés qu'ils sont par la réussite et les affaires.")
milan =   City.create(
  name:"Milan",
...
mantoue =   City.create(
  ...
  description:"C'est d'éclat qu'il faut parler pour décrire Mantoue, cette perle de la Renaissance dont la famille Gonzague fit la richesse et la gloire. En embellissant sans cesse leur Palais Ducal, les ducs de Mantoue ont créé une oeuvre de beauté totale. De riches fresques habillent les murs, les couloirs sont parsemés de mille fleurs peintes et les loggias donnent sur des jardins intérieurs et secrets. Dans la Chambre des Epoux - la pièce la plus connue du palais - Andrea Mantegna a peint avec la famille Gonzague avec sobriété, ainsi qu'un fameux trompe l'oeil au plafond, qui laisse des anges vous regarder depuis leur nuage de crème. Continuons la promenade jusqu'aux portes de la ville, dans le Palazzo Te, où le maniériste Giulio Romano a renversé les perspectives et les ordres de grandeur, nous entrainant à sa suite dans le monde des géants et des dieux.",
  province: lombardie,
...
lacs = Province.create(
  ...
  description:"La beauté des lacs de l'Italie du Nord fascine. Enchâssés dans les Alpes blanches, ils dessinent leurs larges courbes dans la brume des montagnes, tandis que sur leurs rives apparaissent des villages charmants, des villas bordées par des rangées de lauriers, et des palais magnifiques au bout desquels sont amarrés des bateaux en bois. L'homme a ajouté sa délicatesse dans les jardins attenants, qui semblent déposés comme des nénuphars sur l'eau. Le rythme qu'on constate, le silence et la profondeur des lacs font de ces endroits la quintessence du raffinement italien : la richesse trouvée dans une admirable simplicité.")
come =  City.create(
  name:"Lac de Come",
  geocoding: "45° 59′ 40″ NORD 9° 15′ 58″ EST",
  description:"Partons en escapade au lac de Come. Des montagnes au loin se dessinent dans la nuée, l'eau claque contre les escaliers des palais édifiés par la noblesse lombarde et les statues rêvent en regardant l'horizon. Depuis l'époque romaine, on y a construit des demeures merveilleuses entre ciel et eau, dont la plus emblématique est sans doute la villa Carlotta. Ses jardins en triple cascades se jettent dans le lac pour prolonger la vue sur l'infini, alors qu'à l'intérieur, des marbres de Canova reposent sous des plafonds d'or. Plus loin, on trouve la villa Monastero. Elle accueille ses promeneurs par une longue balade fleurie sur graviers blancs, avec vue sur le lac immobile et bleu, sur ce lac de Come que le soleil fait scintiller en mille endroits, comme un diamant liquide.",
  province: lacs,
...
florence =  City.create(
  ...
  description: "Ville binaire et géométrique, Florence est sans demi-mesure. Elle est parfois sombre, avec un ciel bas et des bâtisses austères qui rappellent son passé politique sulfureux fait de dangers et de luttes : se sont affrontés les Guelfes contre les Gibelins, les Franciscains contre les Dominicains, les Medicis contre les Pazzi, Savenarole contre Laurent le Magnifique. Et puis, inversée comme par miracle, elle apparait soudain légère, saupoudrée d'or, parsemée de chapelles et de cloîtres aux peintures les plus douces. À Florence, la Beauté est un pouvoir depuis qu'au quinzième siècle, Cosme de Médicis demanda à l’architecte Brunelleschi de construire le Dôme chargé de recouvrir la cathédrale Santa Maria del Fiore. Par ce moyen, le mécène Médicis avait lancé la Renaissance, qui fut un foisonnement artistique et intellectuel sans précédent.",
  province: toscane,
...
Picture.create(
  url:"https://raw.githubusercontent.com/CapucineC/iMages/master/San%20Gimignano/san_29.jpg",
  position: 29,
  css_class: "all",
  city: sangimignano
)
...
latium = Province.create(
  name: "Latium",
  map: "lazio-map.png",
  description:"Pareil à la louve romaine, le Latium est, depuis l'époque antique, une terre nourricière tant sur le plan de l’agriculture que de la culture. C'est une succession de champs cultivés, de paysages blondis par les épis dorés, et d'étendues verdoyantes qui vont des montagnes de l'Apennins à la mer Tyrrhénienne. La région doit son nom au roi Latinus et à ses sujets les Latini, implantés ici après les étrusques et qui parlaient une langue ancêtre du latin archaïque. Le Latium ne compte pas beaucoup de grandes villes il est vrai, mais le Latium a construit Rome, capitale de l'Empire romain, ville la plus chargée d'histoire de toute l'Italie. Au milieux de ses terres, on trouve encore aujourd'hui des ruines de l'empire. Parmi les plus connues, le Colisée de Rome ou les théâtres d'Ostie.")
rome =  City.create(
  name:"Rome",
...
Picture.create(
  url: "https://raw.githubusercontent.com/CapucineC/iMages/master/Lecce/lecce_12.jpg",
  position: 12,
  css_class:"mini",
  city: lecce
)
...
Picture.create(
  url: "https://raw.githubusercontent.com/CapucineC/iMages/master/Lecce/lecce_30.jpg",
  position: 30,
  css_class:"all",
  city: lecce
)
