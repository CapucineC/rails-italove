...
piemont = Province.create(
  ...
  description:"Les montagnes majestueuses qui traversent le Piémont lui ont donné à coup sûr tous ses rêves d’ambition. C’est le Piémont qui a imaginé, voulu et réalisé la création de l’Italie. Comment ne pas rêver de gloire, quand la géographie vous a placé au pied du Mont Blanc, et que vous êtes bercé par les sommets ? À cheval sur deux pays, la région fut longtemps disputé entre la France et l'Italie. Et puis, au fil des siècles, elle fut délimitée autour de Turin par les comtes et les ducs de Savoie. Ils ont ensuite unifié les différentes régions en un seul et même pays aidés en cela par les Cavour, une autre famille piémontaise. Avec ses rochers, ses coteaux chargés de vignes et ses plaines gorgées par l'eau froide du Pô, le Piémont est une région caractérielle traversée par des bourgades montagnardes. En arrière-fond, les monts enneigés des Alpes se détachent et donnent aux paysages une sérénité hors temps.")
turin = City.create(
  name:"Turin",
...
mantoue =   City.create(
  ...
  description:"C'est d'éclat qu'il faut parler pour décrire Mantoue, cette perle de la Renaissance dont la famille Gonzague fit la richesse et la gloire. En embellissant sans cesse leur Palais Ducal, les ducs de Mantoue ont créé une oeuvre de beauté totale. De riches fresques habillent les murs, les couloirs sont parsemées de mille fleurs peintes et les loggias donnent sur des jardins intérieurs et secrets. Dans la Chambre des Epoux - la pièce la plus connue du palais - Andrea Mantegna a peint ses maîtres avec beaucoup de diligence, ainsi qu'un fameux trompe l'oeil au plafond, qui laisse des anges vous regarder depuis leur nuage. Continuons la promenade jusqu'aux portes de la ville, dans le Palazzo Te où le peintre maniériste Giulio Romano a renversé les perspectives et les ordres de grandeur, nous entrainant à sa suite dans le monde des géants et des dieux.",
  province: lombardie,
